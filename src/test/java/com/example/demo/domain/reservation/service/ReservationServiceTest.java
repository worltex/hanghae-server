...
class ReservationServiceTest {
    ...
    public void 예약된좌석조회_성공(){
        //given
        Long showId=1L;
        when(reservationRepository.findAllByShowIdAndStatusIn(any(), anyList())).thenReturn(Arrays.asList(new Reservation(1L,1L,1L,1L,new Seat(1L,1,new BigDecimal(1000)),"RESERVED", ZonedDateTime.now())));
