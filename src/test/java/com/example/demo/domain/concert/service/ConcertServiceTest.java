...
//
//        //when & then
//        assertThrows(RuntimeException.class,()->concertService.findByConcertId(concertId));
//    }
//
//    @Test
...
//        Long hallId=1L;
//        Show show = new Show(showId, concertId, ZonedDateTime.now());
//        when(concertRepository.findByConcertId(concertId)).thenReturn(Optional.of(new Concert(concertId, "test", 1L, Arrays.asList(show))));
